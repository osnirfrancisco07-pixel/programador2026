...
<div id="carouselExample" class="carousel slide">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="imagem/1779909443_346b3f2a__imagem2.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="imagem/1779909435_197d16b4__imagem1.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="imagem/1779910131_b7d13cfb__imagem3.png" class="d-block w-100" alt="...">
    </div>
  </div>
...
<section style="background-color: #330672; margin-top: -3px;" >
    <p class="text-center text-white" style="padding: 70px;">
     o Ecolote é um site que tem como objetivo
    ajudar as pessoas   a encontrarem produtos a preços acessíveis,
    economize dinheiro e evite desperdício.
